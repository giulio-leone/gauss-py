...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "GovernanceRule": ("gauss.routing_policy", "GovernanceRule"),
    "GovernancePolicyPack": ("gauss.routing_policy", "GovernancePolicyPack"),
    ...
    "evaluate_policy_diff": ("gauss.routing_policy", "evaluate_policy_diff"),
    "evaluate_policy_rollout_guardrails": ("gauss.routing_policy", "evaluate_policy_rollout_guardrails"),
    ...
    "enforce_routing_time_window": ("gauss.routing_policy", "enforce_routing_time_window"),
