...
class EvalRunner:
    ...
    def __init__(self, threshold: float = 0.8) -> None:
        from gauss._native import create_eval_runner  # type: ignore[import-not-found]
    ...
    def add_scorer(self, scorer_type: str) -> EvalRunner:
        ...
        from gauss._native import eval_add_scorer  # type: ignore[import-not-found]
    ...
    def load_dataset_jsonl(data: str) -> list[dict[str, Any]]:
        ...
        from gauss._native import load_dataset_jsonl  # type: ignore[import-not-found]
    ...
    def load_dataset_json(data: str) -> list[dict[str, Any]]:
        ...
        from gauss._native import load_dataset_json  # type: ignore[import-not-found]
    ...
    def destroy(self) -> None:
        if not self._destroyed:
            from gauss._native import destroy_eval_runner  # type: ignore[import-not-found]
