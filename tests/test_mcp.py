...
class TestMcpTypes:
    ...
    def test_mcp_content_from_dict_text(self):
        c = McpContent.from_dict({"type": "text", "text": "hi"})
        assert c.text == "hi"

    def test_mcp_content_from_dict_image(self):
        c = McpContent.from_dict({"type": "image", "data": "x", "mimeType": "image/png"})
        assert c.data == "x"

    def test_mcp_content_from_dict_resource(self):
    ...
    def test_mcp_prompt_message_from_dict(self):
    ...
    def test_mcp_prompt_result_from_dict(self):
    ...
    def test_mcp_model_preferences(self):
    ...
    def test_mcp_sampling_request(self):
    ...
    def test_mcp_sampling_response_from_dict(self):
