...
import pytest
from gauss.spec import AgentSpec, SkillSpec
...
class TestAgentSpec:
    def test_parses_complete_agents_md(self) -> None:
    ...
    def test_parses_tools_with_parameters(self) -> None:
        spec = AgentSpec.from_markdown(SAMPLE_AGENTS_MD)
    ...
    def test_parses_skills_and_capabilities(self) -> None:
        spec = AgentSpec.from_markdown(SAMPLE_AGENTS_MD)
    ...
    def test_parses_environment_variables(self) -> None:
        spec = AgentSpec.from_markdown(SAMPLE_AGENTS_MD)
    ...
    def test_minimal_agents_md(self) -> None:
...
class TestSkillSpec:
    ...
    def test_minimal_skill_md(self) -> None:
        minimal = "# Simple\n\n## Description\nA simple skill."
